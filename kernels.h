...
__global__ void matmul_mha_transpose_scale(const float scale_factor, const float *A, const float *B, float *C, int height, int width, int dim, int head_dimm, int N);
